 ...
 *
 * Primary: Amber/Orange (warmth, analog, vinyl labels)
 * Secondary: Deep purple (creative energy, night vibes)
 * Neutrals: Warm grays with subtle brown undertones
 */
...
export default {
  ...
  theme: {
    extend: {
      ...
      // ═══════════════════════════════════════════════════════════
      // TYPOGRAPHY - Distinctive but readable
      // ═══════════════════════════════════════════════════════════
      fontFamily: {
        // Display font - Bold, modern, geometric
        // Satoshi: Clean, contemporary, slightly rounded
        'display': ['Satoshi', 'system-ui', 'sans-serif'],

        // Body font - Highly readable, warm character
        // General Sans: Modern, slightly warm, excellent readability
        'sans': ['General Sans', 'system-ui', 'sans-serif'],

        // Mono font - For technical info, timestamps
